...
<body>
			...
			<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="2" align="center">
						...
						<input type="button" name="Submit5" value="关闭" onclick="toCloseAdd()"></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<div id="LayerEdit">
		<form name="editForm" id="editForm" method="post" action="">
			...
			<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td width="47%" align="right">用户名：</td>
					<td width="53%"><input name="userName" type="text" id="userName" readonly="readonly"></td>
				</tr>
				<tr>
					<td align="right">年龄：</td>
					<td><input name="age" type="text" id="age"></td>
				...
				<tr>
					...
					<input type="button" name="Submit5" value="关闭" onclick="toCloseEdit()"></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<table width="539" border="0">
		<tr>
			...
			<input type="button" name="Submit2" value="修改" onclick="toShowEdit()"> 
			<input type="button" name="Submit3" value="删除" onclick="toDelete()"></td>
		</tr>
		<tr>
			<td>
